...
HTCONDOR_COMAND="/opt/conda/bin/python -m distributed.cli.dask_worker 129.93.183.33:8787 --name $NAME --nthreads 4  --memory-limit 2000.00MB --name 0 --nanny --death-timeout 60"
